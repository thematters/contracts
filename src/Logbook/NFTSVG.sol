...
library NFTSVG {
    ...
    function generateSVGPathsA(SVGParams memory params) internal pure returns (string memory svg) {
        ...
        paths[0] = string(
            abi.encodePacked(
                '<path d="M128.19 145a30 30 0 0 0-30 30v4.47a30 30 0 0 0 30 30h18.13a30 30 0 0 1 30 30v17.8a30 30 0 0 0 30 30h.91a30 30 0 0 0 30-30V175a30 30 0 0 0-30-30h-79.04Z" fill-opacity=".5" fill="',
                colorA,
                '"/>'
            )
        );
        paths[1] = string(
            abi.encodePacked(
                '<path d="M470.53 334.64a30 30 0 0 0-30-30h-4.4a30 30 0 0 0-30 30v19.76a30 30 0 0 1-30 30H358.4a30 30 0 0 0-30 30v2.17a30 30 0 0 0 30 30h82.12a30 30 0 0 0 30-30v-81.93Z" fill-opacity=".5" fill="',
                colorA,
                '"/>'
            )
        );
        paths[2] = string(
            abi.encodePacked(
                '<path d="M362.26 368.56a30 30 0 0 0 30-30v-4.47a30 30 0 0 0-30-30h-18.13a30 30 0 0 1-30-30v-17.8a30 30 0 0 0-30-30h-.9a30 30 0 0 0-30 30v82.27a30 30 0 0 0 30 30h79.03Z" fill-opacity=".5" fill="',
                colorA,
                '"/>'
            )
        );
        ...
        paths[4] = string(
            abi.encodePacked(
                '<path d="M210 381.01h-5.84a30 30 0 0 0-30 30v3.6a30 30 0 0 0 30 30H210a30 30 0 0 0 30-30V411a30 30 0 0 0-30-30ZM134.02 613.75h-5.83a30 30 0 0 0-30 30v3.6a30 30 0 0 0 30 30h5.83a30 30 0 0 0 30-30v-3.6a30 30 0 0 0-30-30Z" fill-opacity=".5" fill="',
                colorA,
                '"/>'
            )
        );
        paths[5] = string(
            abi.encodePacked(
                '<path d="M467.91 182.53v-7.2a30 30 0 0 0-30-30H437a30 30 0 0 0-30 30v7.2a30 30 0 0 0 30 30h.91a30 30 0 0 0 30-30Z" fill-opacity=".5" fill="',
                colorA,
                '"/>'
            )
        );
    ...
    function generateSVGTexts(SVGParams memory params) internal pure returns (string memory svg) {
        ...
        texts[0] = string(
            abi.encodePacked(
                '<text stroke="#333" fill="#333" font-family="Roboto, Tahoma-Bold, Tahoma" font-size="48" font-weight="bold"><tspan x="99.3" y="105.4">LOGBOOK</tspan></text>',
        ...
        texts[1] = string(
            abi.encodePacked(
                '<text stroke="',
                colorBackground,
                '" stroke-width="20" font-family="Roboto, Tahoma-Bold, Tahoma" font-size="18" font-weight="bold" fill="#000"><tspan x="98" y="724.2">',
                placeholders,
                "</tspan></text>"
            )
        );
